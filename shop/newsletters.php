...
<head>
    <title>Newsletter de Familov.com</title>
</head>
<body bgcolor="black">
<font face="verdana"><font color="white"><font size="5"><p align="center"><font color="red"><u>Balzac61</u></font></p></font>
<font size="3">
<p align="left">Voici les dernières news de Familov.com :<br /><ul>'; //On définit le message.
...
$destinataire = $liste;
$date = date("d/m/Y");
$objet = "Newsletter de Familov.com du $date"; // On définit l'objet qui contient la date.
