...
include ('inc/dbConnect.inc.php');
	...
	$sql78dss = "SELECT * from cms where id = 1";
...
$insertintotable = ("UPDATE cms SET content_about='$content_about' WHERE id=1");
    ...
    margin-top: -10px;
    padding-bottom: 5px;
    padding-top: 5px;"> Privacy Policy Update Successfully </div>';
    }
		 }
		?>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
								<?php echo $message; ?>	
									<form role="form" name="contact" action="privacy_policy.php" method="post"  enctype="multipart/form-data">
