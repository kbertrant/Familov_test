        ...
        <div class="row-padding">
            <div class="row footer-wrapper">
                ...
                <div class="col-sm-3">
                    ...
                    <a href="how.php"><?php echo gettext("How it works");?></a>
                    <a href="faq.php"><?php echo gettext("Support");?></a>
                    <a href="terms.php"><?php echo gettext("Terms");?></a>
                    <a href="privacy.php"><?php echo gettext("Privacy");?></a>
                ...
                <div class="col-sm-3">
                    <div class="height-15"></div>
                    <a href="abouts.php"><?php echo _("About");?></a>
                    <!--	<a href="why.php">Why us ?</a>-->
                    <a href="contact.php">Contact</a>
                    <a href="press.php">Press</a>
                    <a href="job.php"><?php echo _("Jobs");?></a>
                ...
                <div class="col-sm-3">
                    ...
                    <a href="merchant.php"><?php echo gettext("For Businesses");?></a>
                    <!--	<a href="#">Seller</a>-->
                ...
                <div class="row footer-wrapper">
                    ...
                    <div class="col-sm-6">
                        <div class="footer-payoffX">	<div class="footer-payoffX"><?php echo gettext("Made with");?> <i class="icon-heart"></i></a><?php echo gettext(" in Saarbrücken");?>  </div>  </div>
...
if(isset($country_id) != "" && isset($city_id) != "" && isset($shop_id) != ""){
    ?>
