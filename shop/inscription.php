...
?>
    ...
    <head>
        ...
        {
            ?>
            <meta http-equiv="refresh" content="1; url=http://www.familov.com/shop" /> <!-- Redirection vers la page d'accueil du site si on a entré son e-mail. -->
        <?php
        }
        else
        {
            ?>
            <meta http-equiv="refresh" content="25; url=http://www.familov.com/shop/" /> <!-- Redirection vers la page d'accueil du site si on tarde trop à entrer son e-mail. -->
        <?php
        }
        ?>
        <title>Validation de votre inscription à la newsletter de familov.com</title>
    </head>
<body>
...
elseif($_GET['tru']==2) // Sinon, si la variable $_GET['tru'] est égale à 2.
{
    ...
    if($email_entre==$email_mail) // Si les deux adresses e-mail sont identiques.
    {
        ...
        echo "Vous avez bien été inscrit à la newsletter de familov.com ! Vous allez être redirigé dans 1 seconde.";
    }
    else
    {
