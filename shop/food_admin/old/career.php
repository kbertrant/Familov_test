...
include ('inc/dbConnect.inc.php');
	...
	$sql78dss = "SELECT * from cms where id = 3";
...
$insertintotable = ("UPDATE cms SET content_about='$content_about' WHERE id=3");
    ...
    margin-top: -10px;
    padding-bottom: 5px;
    padding-top: 5px;"> Career Update Successfully </div>';
    }
		 }
		?>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
								<?php echo $message; ?>	
									<form role="form" name="contact" action="career.php" method="post"  enctype="multipart/form-data">
